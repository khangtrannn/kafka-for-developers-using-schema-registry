...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3639361367072575843L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"org.khang\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static org.khang.Greeting.Builder newBuilder() {
    return new org.khang.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.khang.Greeting.Builder newBuilder(org.khang.Greeting.Builder other) {
    if (other == null) {
      return new org.khang.Greeting.Builder();
    } else {
      return new org.khang.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.khang.Greeting.Builder newBuilder(org.khang.Greeting other) {
    if (other == null) {
      return new org.khang.Greeting.Builder();
    } else {
      return new org.khang.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.khang.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.khang.Greeting other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.Greeting.Builder clearGreeting() {
      greeting = null;
