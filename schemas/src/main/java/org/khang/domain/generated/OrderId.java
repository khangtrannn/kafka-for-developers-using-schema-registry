...
public class OrderId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5176826481703859426L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderId\",\"namespace\":\"org.khang.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public static org.khang.domain.generated.OrderId.Builder newBuilder() {
    return new org.khang.domain.generated.OrderId.Builder();
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static org.khang.domain.generated.OrderId.Builder newBuilder(org.khang.domain.generated.OrderId.Builder other) {
    if (other == null) {
      return new org.khang.domain.generated.OrderId.Builder();
    } else {
      return new org.khang.domain.generated.OrderId.Builder(other);
    }
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static org.khang.domain.generated.OrderId.Builder newBuilder(org.khang.domain.generated.OrderId other) {
    if (other == null) {
      return new org.khang.domain.generated.OrderId.Builder();
    } else {
      return new org.khang.domain.generated.OrderId.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.khang.domain.generated.OrderId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.khang.domain.generated.OrderId other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.OrderId.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.OrderId.Builder clearId() {
