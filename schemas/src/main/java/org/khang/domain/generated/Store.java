...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private int id;
  private org.khang.domain.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, org.khang.domain.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (org.khang.domain.generated.Address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.khang.domain.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(org.khang.domain.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static org.khang.domain.generated.Store.Builder newBuilder() {
    return new org.khang.domain.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.khang.domain.generated.Store.Builder newBuilder(org.khang.domain.generated.Store.Builder other) {
    if (other == null) {
      return new org.khang.domain.generated.Store.Builder();
    } else {
      return new org.khang.domain.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.khang.domain.generated.Store.Builder newBuilder(org.khang.domain.generated.Store other) {
    if (other == null) {
      return new org.khang.domain.generated.Store.Builder();
    } else {
      return new org.khang.domain.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private org.khang.domain.generated.Address address;
    private org.khang.domain.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.khang.domain.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = org.khang.domain.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.khang.domain.generated.Store other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.Store.Builder setAddress(org.khang.domain.generated.Address value) {
     ...
     * @return This builder.
     */
    public org.khang.domain.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(org.khang.domain.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(org.khang.domain.generated.Address.newBuilder());
        }
      }
    ...
    public org.khang.domain.generated.Store.Builder setAddressBuilder(org.khang.domain.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public org.khang.domain.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (org.khang.domain.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new org.khang.domain.generated.Address();
      }
